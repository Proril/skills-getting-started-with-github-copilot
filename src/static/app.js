              ...
              .map(
                (participant) => `
                  <li>
                    ...
                    <button type="button" class="delete-participant" data-activity="${name}" data-email="${participant}" aria-label="Remove ${participant}" title="Remove participant">&times;</button>
                  </li>`
              )
              .join("")
